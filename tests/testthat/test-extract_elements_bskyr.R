...
test_that("extract_many_posts_author_infos_bskyr works", {
  author_infos <- extract_many_posts_author_infos_bskyr(bskyr_like_output)
  expect_equal(
...
test_that("extract_many_posts_text_bskyr works", {
  text <- extract_many_posts_text_bskyr(bskyr_like_output)
...
test_that("extract_many_posts_created_at_bskyr works", {
  created_at <- extract_many_posts_created_at_bskyr(bskyr_like_output)
...
test_that("extract_many_posts_langs_bskyr works", {
  langs <- extract_many_posts_langs_bskyr(bskyr_like_output)
...
test_that("extract_many_posts_hashtags_bskyr works", {
  hashtags <- extract_many_posts_hashtags_bskyr(bskyr_like_output)
...
test_that("extract_many_posts_elements_bskyr works", {
  elements <- extract_many_posts_elements_bskyr(bskyr_like_output)
  expect_equal(
...
test_that("extract_many_posts_url_bskyr works", {
  post_url <- extract_many_posts_url_bskyr(bskyr_like_output)
  expect_equal(
    post_url[[1]],
    "https://bsky.app/profile/did:plc:k6vq7z2d5lyhhqnxs72tlchg/post/3ltlzhcvjqc2g"
  )
